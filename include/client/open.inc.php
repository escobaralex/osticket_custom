...
<form id="ticketForm" method="post" action="open.php" enctype="multipart/form-data">
  ...
  <table width="800" cellpadding="1" cellspacing="0" border="0">
    <tbody>
    <tr>
        <td class="required">Tipo de Asistencia:</td>
        <td>
            <select id="topicId" name="topicId" onchange="javascript:
                    ...
                    ">
                <option value="" selected="selected">&mdash; Seleccione un Tipo de Asistencia &mdash;</option>
                <?php
                if($topics=Topic::getPublicHelpTopics()) {
                    ...
                    <option value="0" >Requerimiento General</option>
                <?php
                } ?>
            </select>
...
<?php
        ...
        <tr><td>Cliente:</td><td><?php echo $thisclient->getName(); ?></td></tr>
        <?php } ?>
    </tbody>
    ...
    if($cfg && $cfg->isCaptchaEnabled() && (!$thisclient || !$thisclient->isValid())) {
        if($_POST && $errors && !$errors['captcha'])
            $errors['captcha']='Por favor vuelva a ingresar el Texto';
        ?>
    <tr class="captchaRow">
        ...
        <td>
            ...
            <em>Ingrese el Texto mostrado en la Imagen.</em>
