...
<div id="msg_info">
    ...
    <strong>Buscando sus otros Tickets?</strong></br>
    <a href="<?php echo ROOT_PATH; ?>login.php?e=<?php
        echo urlencode($thisclient->getEmail());
        ?>" style="text-decoration:underline">Inscribase</a> o
    <a href="account.php?do=create" style="text-decoration:underline">ingrese con su cuenta</a>
    para una mejor experiencia con nuestra Mesa de Ayuda.</div>
...
<?php if ($cfg->allowClientUpdates()
        ...
        && $thisclient->getId() == $ticket->getUserId()) { ?>
                <a class="action-button" href="tickets.php?a=edit&id=<?php
                     echo $ticket->getId(); ?>"><i class="icon-edit"></i> Editar</a>
<?php } ?>
            </h1>
        </td>
    </tr>
    ...
    <table border="0" cellspacing="0" cellpadding="3" style="width:100%">
        <tr>
            <td colspan="2">
                <?php
                if($ticket->isClosed()) {
                    $msg='<b>*** ESTE TICKET SE ENCUENTRA CERRADO - FAVOR CREE UN NUEVO TICKET ***</b>';
                } else {
                    $msg='Para poder ayudarle, por favor sea especifico y detallista.';
                }
                ?>
